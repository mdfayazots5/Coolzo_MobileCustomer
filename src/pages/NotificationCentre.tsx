...
import { APP_NOTIFICATIONS } from '@/lib/mockData';

const NotificationCentre = () => {
  const navigate = useNavigate();
  const [notifications, setNotifications] = useState(APP_NOTIFICATIONS);
            ...
            return (
              ...
              >
                ...
                <div className={cn(
                  ...
                  notif.type === 'Job' ? "bg-blue-50 text-blue-500" :
                  notif.type === 'Payment' ? "bg-green-50 text-green-500" :
                  notif.type === 'Support' ? "bg-purple-50 text-purple-500" :
                ...
                <div className="flex-1 pr-4">
                  ...
                  <p className="text-navy/60 text-xs leading-relaxed mb-3">{notif.body}</p>
